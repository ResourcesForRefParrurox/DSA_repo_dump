/**
 * Title     : Answer Minimum queries (Find the minimum of all elements in a given range)
...
void build(int idx, int l, int r) {
    ...
    // any node (except leaf) contains the minimum between its left and right child
    seg[idx] = min(seg[2 * idx], seg[2 * idx + 1]);
}

/* Find minimum of all elements in the range [l, r] */
