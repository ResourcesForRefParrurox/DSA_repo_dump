/**
 * Title     : Answer XOR queries allowing point update
...
int main() {
    ...
    while (q--) {
        ...
        // Query type 1 -> replace the element at target index with new value
        // Query type 2 -> find the XOR of elements in the range [l, r]
        int type;
        cin >> type;
