/**
 * Title     : Answer Sum queries (Find the sum of all elements in a given range)
...
void build(int idx, int l, int r) {
    ...
    // any node (except leaf) contains the sum of its left and right child
    seg[idx] = seg[2 * idx] + seg[2 * idx + 1];
}

/* Find sum of all elements in the range [l, r] */
